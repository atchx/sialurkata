...
<div class="col-md-8">
    <div class="main-card mb-3 card">
        <div class="card-body"><h5 class="card-title">Dokumen RANPERDA TENTANG APBD DAN RANPERKADA TENTANG PENJABARAN APBD</h5>
            <form method="post" action="/dashboard/documentapbds/{{ $document->id }}" enctype="multipart/form-data" class="">
                @method('put')
                @csrf
                ...
                <a href="/dashboard/documentapbds/{{ $document->keputusan_id }}" class="mt-1 btn btn-warning">Batal</a>
            </form>
        </div>
    </div>
</div>
