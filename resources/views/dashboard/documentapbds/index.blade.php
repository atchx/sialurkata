...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            ...
            @endif
            <div class="card-header">Dokumen Kelengkapan Ranperda Tentang APBD dan Ranperkada Tentang Penjabaran APBD
                ...
                <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="/dashboard/documentapbds/{{ $keputusan->id }}" class="btn btn-primary btn-sm">Details</a>
                                @if (auth()->user()->roles == 'Admin')
                                @if ($keputusan->dokumen == null)
                                <a href="/dashboard/documentapbds/apbds/{{ $keputusan->id }}/edit" class="btn btn-warning btn-sm">Upload</a>
                                @else
                                <form action="/dashboard/documentapbds/apbds/{{ $keputusan->id }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
