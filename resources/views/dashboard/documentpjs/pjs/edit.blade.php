...
<div class="col-md-8">
    <div class="main-card mb-3 card">
        <div class="card-body"><h5 class="card-title">Upload File Dokumen RANPERDA TENTANG PERTANGGUNGJAWABAN PELAKSANAAN APBD DAN RANPERKADA TENTANG PENJABARAN PERTANGGUNGJAWABAN APBD</h5>
            <form method="post" action="/dashboard/documentpjs/pjs/{{ $keputusan->id }}" enctype="multipart/form-data" class="">
                @method('put')
                @csrf
                ...
                <div class="position-relative form-group"><a href="/dashboard/keputusanpjs/{{ $keputusan->id }}" target="_blank" class="mt-1 btn btn-info">Lihat Dokumen</a></div>
                ...
                <a href="/dashboard/documentpjs/{{ $keputusan->keputusan_id }}" class="mt-1 btn btn-warning">Batal</a>
            </form>
        </div>
    </div>
</div>
