...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            ...
            @endif
            <div class="card-header">Keputusan Gubernur Ranperda Tentang APBD dan Ranperkada Tentang Penjabaran APBD
            </div>
                ...
                <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if (auth()->user()->roles == 'Admin')
                            <td class="text-center">
                                <a href="/dashboard/keputusanapbds/{{ $keputusan->id }}/edit" class="btn btn-primary btn-sm">Upload</a>
                                <form action="/dashboard/keputusanapbds/{{ $keputusan->id }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
