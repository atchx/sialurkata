...
<div class="row">
    <div class="col-md-12">
        <div class="main-card mb-3 card">
            ...
            @endif
            <div class="card-header">Keputusan Gubernur Ranperda Tentang Pertanggungjawaban Pelaksanaan APBD dan Ranperkada Tentang Penjabaran Pertanggungjawaban APBD
            </div>
                ...
                <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            @if (auth()->user()->roles == 'Admin')
                            <td class="text-center">
                                <a href="/dashboard/keputusanpjs/{{ $keputusan->id }}/edit" class="btn btn-primary btn-sm">Upload</a>
                                <form action="/dashboard/keputusanpjs/{{ $keputusan->id }}" method="post" class="d-inline">
                                    @method('delete')
                                    @csrf
