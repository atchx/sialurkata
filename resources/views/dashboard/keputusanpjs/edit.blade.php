...
<div class="col-md-8">
    <div class="main-card mb-3 card">
        <div class="card-body"><h5 class="card-title">Upload Keputusan Gubernur RANPERDA TENTANG PERTANGGUNGJAWABAN PELAKSANAAN APBD DAN RANPERKADA TENTANG PENJABARAN PERTANGGUNGJAWABAN APBD</h5>
            <form method="post" action="/dashboard/keputusanpjs/{{ $keputusan->id }}" enctype="multipart/form-data" class="">
                @method('put')
                @csrf
                ...
                <a href="/dashboard/keputusanpjs/" class="mt-1 btn btn-warning">Batal</a>
            </form>
        </div>
    </div>
</div>
