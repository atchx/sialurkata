...
<div class="col-md-8">
    <div class="main-card mb-3 card">
        <div class="card-body"><h5 class="card-title">Tambah Dokumen RANPERDA TENTANG PERUBAHAN APBD DAN RANPERKADA TENTANG PENJABARAN PERUBAHAN APBD</h5>
            <form method="post" action="/dashboard/documentpapbs" enctype="multipart/form-data" class="">
                @csrf
                ...
                <a href="/dashboard/documentpapbs/" class="mt-1 btn btn-warning">Batal</a>
            </form>
        </div>
    </div>
</div>
